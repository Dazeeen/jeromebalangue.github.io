...
test("published review data renders safe horizontal testimonial cards without profile photos", () => {
...
test("the testimonial list continuously auto-scrolls, pauses for interaction, and respects reduced motion", () => {
    ...
    assert.match(css, /\.home-testimonials__track\.is-ready\s*\{[\s\S]*?animation: home-testimonials-scroll/u);
    ...
    assert.match(html, /static\/css\/main\.css\?v=1\.0\.51/u);
    assert.match(html, /static\/js\/main\.js\?v=1\.0\.44/u);
});
